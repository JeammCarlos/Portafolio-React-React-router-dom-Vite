...
const InfoPersonal = () => {
  return (
    <div className="container">
      <img src="../src/images/foto_cv_lc_es_4.jpg" className="photo-personal" alt="Foto de perfil" /> 
      ...
      <div className="second-container">
        <section className="profile-description">
          <h2>Sobre mí</h2>
          <p>
            Desarrollador front end con 12 años de experiencia dirigiendo
            proyectos de diseño de páginas web. Centrado en la creación de
            códigos claros y con capacidad para cumplir los objetivos y las
